        ...
        <div className="card col-md-10 border">
            <div className="card-body">
                ...
                <div className="text-right">
                    <button className="btn btn-blueCh m-1" onClick={this.handleEdit}>edit post</button>
                    <button className="btn btn-blueCh" onClick={this.handleDelete}>delete post</button>
                </div>
            </div>
        </div>
    </>
